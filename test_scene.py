...
class Signal(Scene):
    ...
    def construct(self):
        ...
        self.play(d_theta.animate.increment_value(16*TAU), rate_func=linear, run_time=8)
        ...
        self.play(d_theta.animate.increment_value(16.5*2*TAU), rate_func=linear, run_time=16.5)
